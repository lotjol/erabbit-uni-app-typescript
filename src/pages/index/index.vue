    ...
    <view class="panel recommend">
      <view class="item">
        ...
        >
          <image
            mode="aspectFit"
            src="http://static.botue.com/erabbit/static/uploads/goods_small_1.jpg"
          ></image>
          <image
            mode="aspectFit"
            src="http://static.botue.com/erabbit/static/uploads/goods_small_2.jpg"
          ></image>
        </navigator>
      </view>
      <view class="item">
        ...
        >
          <image
            mode="aspectFit"
            src="http://static.botue.com/erabbit/static/uploads/goods_small_3.jpg"
          ></image>
          <image
            mode="aspectFit"
            src="http://static.botue.com/erabbit/static/uploads/goods_small_4.jpg"
          ></image>
        </navigator>
      </view>
      <view class="item">
        ...
        >
          <image
            mode="aspectFit"
            src="http://static.botue.com/erabbit/static/uploads/goods_small_5.jpg"
          ></image>
          <image
            mode="aspectFit"
            src="http://static.botue.com/erabbit/static/uploads/goods_small_6.jpg"
          ></image>
        </navigator>
      </view>
      <view class="item" @click="nextVersion">
        ...
        <navigator hover-class="none" class="cards">
          <image
            mode="aspectFit"
            src="http://static.botue.com/erabbit/static/uploads/goods_small_7.jpg"
          ></image>
          <image
            mode="aspectFit"
            src="http://static.botue.com/erabbit/static/uploads/goods_small_8.jpg"
          ></image>
        </navigator>
      </view>
    </view>
    ...
    <view class="panel fresh">
      ...
      <view class="cards">
        <navigator hover-class="none" url="/pages/goods/index">
          <image
            mode="aspectFit"
            src="http://static.botue.com/erabbit/static/uploads/goods_small_9.jpg"
          ></image>
        ...
        <navigator hover-class="none" url="/pages/goods/index">
          <image
            mode="aspectFit"
            src="http://static.botue.com/erabbit/static/uploads/goods_small_10.jpg"
          ></image>
        ...
        <navigator hover-class="none" url="/pages/goods/index">
          <image
            mode="aspectFit"
            src="http://static.botue.com/erabbit/static/uploads/goods_small_11.jpg"
          ></image>
        ...
        <navigator hover-class="none" url="/pages/goods/index">
          <image
            mode="aspectFit"
            src="http://static.botue.com/erabbit/static/uploads/goods_small_12.jpg"
          ></image>
